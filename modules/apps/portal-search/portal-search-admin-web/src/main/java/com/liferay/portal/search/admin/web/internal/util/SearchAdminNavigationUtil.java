...
/**
 * Resolves which of the application's tabs the user may reach. Both the
 * application's navigation bar and the side navigation's filter read this, so
 * that a tab is never offered in one place and missing from the other.
 *
