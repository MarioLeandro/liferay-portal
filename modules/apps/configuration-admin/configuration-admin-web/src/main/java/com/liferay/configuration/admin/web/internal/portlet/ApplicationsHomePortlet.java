...
@Component(
	property = {
		...
		"jakarta.portlet.init-param.view-template=/homes/applications-home-view.jsp",
		"jakarta.portlet.name=" + ConfigurationAdminPortletKeys.APPLICATIONS_HOME,
...
public class ApplicationsHomePortlet extends MVCPortlet {
