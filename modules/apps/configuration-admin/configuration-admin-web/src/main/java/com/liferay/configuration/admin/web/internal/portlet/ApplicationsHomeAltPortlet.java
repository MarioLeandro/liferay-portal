...
@Component(
	property = {
		...
		"jakarta.portlet.display-name=Applications Home",
		"jakarta.portlet.info.keywords=osgi,site,settings",
		"jakarta.portlet.init-param.template-path=/META-INF/resources/",
		"jakarta.portlet.init-param.view-template=/homes/applications-home-alt-view.jsp",
		"jakarta.portlet.name=" + ConfigurationAdminPortletKeys.APPLICATIONS_HOME_ALT,
...
public class ApplicationsHomeAltPortlet extends MVCPortlet {
