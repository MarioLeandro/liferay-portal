...
@Component(
	property = {
		...
		"jakarta.portlet.display-name=Commerce Home",
		"jakarta.portlet.info.keywords=osgi,site,settings",
		"jakarta.portlet.init-param.template-path=/META-INF/resources/",
		"jakarta.portlet.init-param.view-template=/homes/commerce-home-view.jsp",
		"jakarta.portlet.name=" + ConfigurationAdminPortletKeys.COMMERCE_HOME,
...
public class CommerceHomePortlet extends MVCPortlet {
